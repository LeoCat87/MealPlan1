...
# -----------------------------
    ...
    def aggregate_shopping_list():
        # Normalizzazione unità: g↔kg, ml↔l
        to_base = {
            "g": ("g", 1), "kg": ("g", 1000),
            "ml": ("ml", 1), "l": ("ml", 1000),
        ...
        # Riconversione "amichevole": se >=1000 g→kg, se >=1000 ml→l
        rows = []
    ...
    df_display = df.rename(columns={"Ingredient": "Ingrediente", "Qty": "Q.tà", "Unit": "Unità"})
